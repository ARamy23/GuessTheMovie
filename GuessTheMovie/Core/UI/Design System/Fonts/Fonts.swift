...
public extension MPFont {
  /// Bold 34
  static let displayHuge: MPFont = ARFont.displayHuge.toUIKitFont()
  /// Bold 28
  static let displayLarge: MPFont = ARFont.displayLarge.toUIKitFont()
  /// Bold 24
  static let displayMedium: MPFont = ARFont.displayMedium.toUIKitFont()
  /// Bold 20
  static let displaySmall: MPFont = ARFont.displaySmall.toUIKitFont()
  /// Regular 17
  static let textMedium: MPFont = ARFont.textMedium.toUIKitFont()
  /// Regular 15
  static let linkSmall: MPFont = ARFont.linkSmall.toUIKitFont()
  /// Regular 15
  static let textSmall: MPFont = ARFont.textSmall.toUIKitFont()
  /// Regular 13
  static let textXSmall: MPFont = ARFont.textXSmall.toUIKitFont()
}

public extension MPFont {
  /// Display Huge Bold 34
  static let pLargeTitle: MPFont = .displayHuge
  /// Display Large Bold 28
  static let pTitle1: MPFont = .displayLarge
  /// Display Medium Bold 24
  static let pTitle2: MPFont = .displayMedium
  /// Display Small Bold 20
  static let pTitle3: MPFont = .displaySmall
  /// Text 'Medium Size' 'Regular Weight' 17
  static let pHeadline: MPFont = .textMedium
  /// Link Small Regular 15
  static let pSubheadline: MPFont = .linkSmall
  /// Text Small Regular 15
  static let pBody: MPFont = .textSmall
  /// Text XSmall Regular 13
  static let pFootnote: MPFont = .textXSmall
}
...
public final class FontManager {
  ...
  public func getSuitableFont(
    ...
    guard let suitableFont = configuration.availableFonts
            .first(where: {
              $0.fontLocale.toLanguage() == UserService.shared.language.value
            })
